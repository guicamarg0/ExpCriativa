...
if ($idTreinoAtleta <= 0 || $idMetrica <= 0 || $valor === '') {
...
$stmt = $conexao->prepare("
    INSERT INTO desempenho_atleta (id_treino_atleta, id_metrica, valor, observacao)
    VALUES (?, ?, ?, ?)
");
...
$stmt->bind_param("iiss", $idTreinoAtleta, $idMetrica, $valor, $observacao);
