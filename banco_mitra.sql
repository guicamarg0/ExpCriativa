...
CREATE TABLE treino_metricas (
    id_treino INT NOT NULL,
    id_metrica INT NOT NULL,

    PRIMARY KEY (id_treino, id_metrica),
...
CREATE TABLE treino_exercicio_metricas (
    id_treino INT NOT NULL,
    id_exercicio INT NOT NULL,
    id_metrica INT NOT NULL,

    PRIMARY KEY (id_treino, id_exercicio, id_metrica),

    FOREIGN KEY (id_treino, id_exercicio) REFERENCES treino_exercicios(id_treino, id_exercicio) ON DELETE CASCADE,
    FOREIGN KEY (id_metrica) REFERENCES metricas(id) ON DELETE CASCADE
);
...
INSERT INTO metricas (nome, descricao, unidade_medida, tipo, status)
VALUES
('Percepcao de esforco', 'Escala de esforço percebido pelo atleta', '0-10', 'escala_0_10', 'ativo'),
('Carga', 'Carga utilizada no exercicio', 'kg', 'numero', 'ativo'),
('Repeticoes', 'Quantidade de repeticoes realizadas', 'rep', 'numero', 'ativo'),
('Saques', 'Aproveitamento de saques no treino', 'acertos/tentativas', 'aproveitamento', 'ativo');
